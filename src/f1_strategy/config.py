...
class Settings:
    ...
    feature_store_backend: str = os.getenv("F1_FEATURE_STORE_BACKEND", "auto")
    ...
    mlflow_ui_url: str = os.getenv("F1_MLFLOW_UI_URL", os.getenv("F1_MLFLOW_TRACKING_URI", "http://localhost:5000"))
    grafana_url: str = os.getenv("F1_GRAFANA_URL", "http://localhost:3000")
    prometheus_url: str = os.getenv("F1_PROMETHEUS_URL", "http://localhost:9090")
